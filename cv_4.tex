...
\makebox[\textwidth]{ Find out my work at \href{https://github.com/Narasim}{https://github.com/Narasim}} 
%----------------------------------------------------------------------------------------
%	EDUCATION SECTION
%----------------------------------------------------------------------------------------
...
\begin{rSubsection}{Ph.D.}{January 2019 - Present}{}{}	
...
\begin{rSection}{My Peer Reviews}
	...
	\begin{rSubsection}{IEEE Access:}{}{}{}		
		\item[1] Credit card fraud detection based on improved Variational Autoencoder Generative Adversarial Network.
		\item[2] Revolutionizing Perimeter Intrusion Detection: A Machine Learning-Driven Approach with Curated Dataset Generation for Enhanced Security.
		\item[3] Integrating Unsupervised Clustering and Semi-Supervised
		Learning for Faulty Insulator Classification.
		\item[4] Hyper Robust H-infinity Filter and PSO-SVM Based Monitoring of Power Quality Disturbances system.
		\item[5] Anchor Pseudo-supervise Large-scale Incomplete Multi-view Clustering.
	\end{rSubsection}
	\pagebreak
